        ...
        Column(Modifier.fillMaxSize().padding(padding).padding(20.dp)) {
            ...
            Card(shape = RoundedCornerShape(20.dp), colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface)) {
                Column(Modifier.padding(20.dp)) {
                    Text(today, fontSize = 14.sp, color = MaterialTheme.colorScheme.MaterialTheme.colorScheme.oncolorScheme.surfaceVariant)
                    ...
                    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceEvenly) {
                        moods.forEach { (emoji, label) ->
                            Column(horizontalAlignment = Alignment.CenterHorizontally,
                                ...
                                Text(label, fontSize = 11.sp, color = if (currentMood.first == emoji) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.MaterialTheme.colorScheme.oncolorScheme.surfaceVariant)
                            }
                        }
                    }
            ...
            if (entries.isEmpty()) {
                ...
                Text("No entries yet. Start journaling!", fontSize = 14.sp, color = MaterialTheme.colorScheme.MaterialTheme.colorScheme.oncolorScheme.surfaceVariant, modifier = Modifier.align(Alignment.CenterHorizontally))
                Spacer(Modifier.weight(1f))
            } else {
                        ...
                        Card(shape = RoundedCornerShape(12.dp), colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface)) {
                            Row(Modifier.padding(16.dp), verticalAlignment = Alignment.Top) {
                                ...
                                Column(Modifier.weight(1f)) {
                                    ...
                                    Text("{entry.date} · {entry.mood}", fontSize = 11.sp, color = MaterialTheme.colorScheme.MaterialTheme.colorScheme.oncolorScheme.surfaceVariant)
                                }
                            }
                        }
                    }
